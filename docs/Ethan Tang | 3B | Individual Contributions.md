...
### Writing of the logic and functionallity of the harmonize method for the harmonizer
  ...
  * Creates a Hashmap with notes cooresponding to the correct scale degrees
  * Harmonizes a melody with one chord using the Hashmap
  * Also accounts for V7 chords 
### Overseeing the main file
  * Logic for screen toggles
  * Conceptualization of many core methods and variables
