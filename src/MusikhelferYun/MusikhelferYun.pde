...
void setup() {
 ...
 //Sounds and Sound Settings, Kai Yun Chao | 3B
  ...
  pitchAs5 = new SoundFile(this, "A#5.mp3");
  pitchB5 = new SoundFile(this, "B5.mp3");
  pitchCs5 = new SoundFile(this, "C#5.mp3");
  pitchD5 = new SoundFile(this, "D5.mp3");
  pitchDs5 = new SoundFile(this, "D#5.mp3");
  pitchE5 = new SoundFile(this, "E5.mp3");
  pitchF5 = new SoundFile(this, "F5.mp3");
  pitchFs5 = new SoundFile(this, "F#5.mp3");
  pitchG5 = new SoundFile(this, "G5.mp3");
  pitchGs5 = new SoundFile(this, "G#5.mp3");
...
void mousePressed() {
  ...
  for (int i = 0; i<pitchButtons.length; i++) {
    if (pitchButtons[i].over) {
      play(pitchButtons[i].val);
    }
  }
}
// Kai Yun Chao | 3B
